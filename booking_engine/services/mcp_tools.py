...
from booking_engine.services.safety_layer import (
    ATTESA_TOOLS, DEFAULT_TOOL_ALLOWLIST, _TOOL_SCHEMAS,
)

# Matches the ATTESA rule in SAFETY_PROMPT: the model says a brief waiting
# phrase before these tools, so their response is held to this floor even
# when the underlying query finishes faster — an instant answer right after
